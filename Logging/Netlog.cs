...
namespace Nistec.Logging
{
    ...
    public static class Netlog
    {
        ...
        public static void EventInfo(string appName, string message, params object[] args)
        {
            Logger.Instance.Info(message, args);
            EventLogger.Write(appName, LoggingExtensions.StrFormat(message, args), System.Diagnostics.EventLogEntryType.Information);
        }
        public static void EventWarning(string appName, string message, params object[] args)
        {
            Logger.Instance.Warn(message, args);
            EventLogger.Write(appName, LoggingExtensions.StrFormat(message, args), System.Diagnostics.EventLogEntryType.Warning);
        }
        public static void EventError(string appName, string message, params object[] args)
        {
            Logger.Instance.Error(message, args);
            EventLogger.Write(appName, LoggingExtensions.StrFormat(message, args), System.Diagnostics.EventLogEntryType.Error);
        }
    }
