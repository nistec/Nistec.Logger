...
namespace Nistec.Logging.IO.Unsafe
{
    ...
    internal class FileReader
    {
        ...
        public static string ReadFile(string filename, Encoding encoding, int offset, int length)
        {
            ...
            try
            {
                ...
                if (fr.Open(filename))
                {
                    ...
                    if (length > 0)
                    {
                        do
                        {
                            bytesRead = fr.Read(buffer, offset, buffer.Length);
                            sb.Append(encoding.GetString(buffer, 0, bytesRead));
                        }
                        while (bytesRead > 0 && bytesRead < length);
                    }
                    else
                    {
                        do
